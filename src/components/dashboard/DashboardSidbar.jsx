...
import {ArrowRightFromSquare, Gear, Persons} from "@gravity-ui/icons"; // icon will replace form react icons 
import {Avatar, Dropdown, Label} from "@heroui/react";

const DashboardSidbar = ({user}) => {

  // here role based dashboard link
const dashboardNavlinks=roleBasedDashboardNavlinks[user?.role] ||[]
// console.log(dashboardNavlinks,'dashboard navlinks are here')

  return (
    <div>


{/* this is the user profile dropdown for dasboard side bar and mobile menu drawer */}
